<template>
  <div>
    ...
    <div id="myChart1" style="width: 600px;height:500px;margin: auto"></div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      setTimeout(()=>{
      this.data1 = this.resultData[0].Keyword.negative;
      ...
      const myCharts2 = this.$echarts.init(document.getElementById('myChart1'));
